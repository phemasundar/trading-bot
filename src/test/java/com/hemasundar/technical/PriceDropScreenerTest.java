...
public class PriceDropScreenerTest {
    ...
    public void testScreenIntradayDrop_Match() {
        try (MockedStatic<ThinkOrSwinAPIs> mockedApis = mockStatic(ThinkOrSwinAPIs.class)) {
            ...
            mockedApis.when(() -> ThinkOrSwinAPIs.getQuotes(anyList())).thenReturn(quotes);
    ...
    public void testScreenMultiDayDrop_Match() {
        try (MockedStatic<ThinkOrSwinAPIs> mockedApis = mockStatic(ThinkOrSwinAPIs.class)) {
            ...
            mockedApis.when(() -> ThinkOrSwinAPIs.getPriceHistory(
    ...
    public void testScreenPriceDrop_ApiErrorGraceful() {
        try (MockedStatic<ThinkOrSwinAPIs> mockedApis = mockStatic(ThinkOrSwinAPIs.class)) {
            mockedApis.when(() -> ThinkOrSwinAPIs.getQuotes(anyList())).thenThrow(new RuntimeException("API Down"));
