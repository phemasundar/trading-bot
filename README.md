...
- **High Test Coverage**: Comprehensive TestNG unit test suite integrated with `jacoco-maven-plugin` enforcing a minimum of **85.00%** instruction coverage across all core business logic, services, technical indicators, and REST APIs.
